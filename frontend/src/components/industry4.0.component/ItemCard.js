        ...
        {dataindustry.map((user) => {
          return (
            <a href="#" key={user.id}>
              {/* <div key={user.id}> */}
              <div
                className="relative flex items-end justify-start w-full text-left bg-center bg-cover h-96 dark:bg-gray-400 hover:scale-110 duration-300 ease-in-out rounded-t-lg"
              ...
              >
                ...
                <a
                  ...
                  href="#"
                  className="no-underline z-10 p-5 font-medium text-md text-xl hover:text-[#ffffff] dark:text-gray-100 "
                >
                  {user.title}
                </a>
              </div>
