    ...
    <div className="container-fluid" >
        <div> 
          ...
          <ul className="list-disc ml-10  mb-6 text-lg">
            <li className="mt-2"> 3D Modeling</li>
            ...
            <li className="mt-2">Creating Arts and Crafts using software and digitally controlled machines</li>
            <li className="mt-2 mb-5">Building and programming automated control devices using Arduino controller</li>
          </ul>
