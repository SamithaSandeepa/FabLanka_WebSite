...
const InternationalTechnologyTransfer = () => {
  return (
    <div className="container-sm text-lg mt-10 shadow-sm py-2 mb-4">
      ...
      <div>
        <p className="mb-3 text-lg leading-relaxed">
          FabLanka Foundation as the pioneering organization of introducing{" "}
          <a
          ...
          works in collaboration with reputed international organizations and
          individuals to facilitate international digital technology transfer
          schemes.
        </p>
      </div>
      {/* <img
...
export default InternationalTechnologyTransfer;
