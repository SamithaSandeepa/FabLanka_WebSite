    ...
    <div className="container-sm text-lg mt-10 shadow-sm py-2 mb-4">
      ...
      <div>
        <p className="mb-3 text-lg leading-relaxed">
          FabLanka follows advance project management methodologies and uses
          latest software for managing its projects and programmes.
        </p>
      </div>
      {/* <img
...
export default ProjectandProgramManagement;
